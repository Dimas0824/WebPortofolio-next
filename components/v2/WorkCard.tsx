    ...
    return (
        <a href={work.link} target="_blank" rel="noopener noreferrer"
            ...
            <div className={shot ? "relative mt-4 aspect-square overflow-hidden rounded-[16px] bg-v2-deep" : "v2-hatch relative mt-4 grid aspect-square place-items-center overflow-hidden rounded-[16px]"}>
                {shot && <img src={shot} alt="" width={720} height={720} loading="lazy" className="absolute inset-0 h-full w-full object-cover object-top" />}
                {!shot && (<>
                ...
                <div className="v2-reveal absolute inset-x-0 bottom-0 bg-gradient-to-t from-v2-canvas via-v2-canvas/92 to-transparent px-4 pb-4 pt-10">
                    <p className="line-clamp-2 text-sm leading-relaxed text-v2-muted">{work.description}</p>
